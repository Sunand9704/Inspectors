  ...
  sections: [
    {
      ...
      content:
        'From INSPECTORS 360 TIV - Known as Condition Based Monitoring 360Â° Technical Industrial Verification â€“  Deliver precise internal visual inspections of critical components for Mining and Metal Plants, Oil & Gas Facilities, FPSO/FSO Vessels, Industrial Plants, and Power & Utility Infrastructure.\n\nBorescope inspection enables direct visual access to hard-to-reach internal areas such as pipes, turbines, engines, and pressure vessels without disassembly. INSPECTORS 360 TIVâ€™s Borescope Inspection Services help detect internal defects, corrosion, deposits, and wear â€” ensuring asset integrity and minimizing costly downtime.'
    },
    {
      heading: 'Why Choose Borescope Inspection from INSPECTORS 360 TIV?',
      content: [
    ...
    },
    {
      ...
      content:
        'INSPECTORS 360 TIV deploys advanced video borescopes and fiberscopes operated by certified inspectors trained to assess internal component conditions accurately. Our services ensure comprehensive internal inspection and quality assurance â€” both on-site and offshore.'
    },
    {
    ...
    },
    {
      ...
      content:
        'Trust INSPECTORS 360 TIVâ€™s borescope inspection services to provide precise internal assessments that enhance asset reliability and safety while minimizing operational disruptions.\n\nTo learn how our Borescope Inspection Services can support your projects across mining, oil & gas, FPSO/FSO, and power sectors, contact INSPECTORS 360 TIV today.'
    }
  ]
};
...
async function upsertBorescopeSection() {
  ...
  if (existing) {
    ...
    // eslint-disable-next-line no-console
    console.log('ðŸ”„ Updated existing borescope section');
    return existing._id;
  }
...
async function linkSectionToPage(sectionId) {
  ...
  await page.save();
  // eslint-disable-next-line no-console
  console.log('ðŸ”— Linked section to testing page');
}
...
async function main() {
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.error('âŒ Backfill failed:', err.message);
    process.exitCode = 1;
  } finally {
